...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className='min-h-screen bg-[#050505] selection:bg-amber-500 selection:text-zinc-950 overflow-x-hidden font-sans'>
      {/* Navbar Fixa */}
      <nav className='fixed top-0 w-full z-100 py-4 px-6 md:px-16 border-b border-white/5 bg-[#050505]/80 backdrop-blur-xl'>
        <div className='max-w-7xl mx-auto flex justify-between items-center'>
          <div className='flex items-center gap-3'>
            <div className='w-8 h-8 bg-amber-500 rounded-lg flex items-center justify-center rotate-45 shadow-[0_0_15px_rgba(245,158,11,0.3)]'>
              <Scissors
                className='text-zinc-950 size-4 -rotate-45'
                strokeWidth={3}
              />
            </div>
          ...
          <div className='flex items-center gap-3'>
            <Link
              to='/login'
              className='px-4 py-2 rounded-lg text-zinc-400 text-[9px] font-black uppercase tracking-widest hover:text-white transition-all'
            >
              ENTRAR
            </Link>
            <Link
      ...
      <section className='relative pt-32 pb-16 md:pt-48 md:pb-32 overflow-hidden'>
        <div className='absolute top-0 left-1/2 -translate-x-1/2 w-200 h-100 bg-amber-500/4 blur-full rounded-full -z-10' />
        ...
        <div className='max-w-6xl mx-auto px-6 md:px-16 text-center space-y-10'>
          ...
          >
            <div className='inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900/50 border border-white/5 backdrop-blur-md'>
              ...
              <span className='text-zinc-400 text-[8px] font-black uppercase tracking-[0.3em]'>
                Elite Tech Standard
              </span>
            </div>
            ...
            <h1 className='text-4xl md:text-6xl lg:text-7xl font-black text-white leading-tight tracking-tighter uppercase max-w-5xl mx-auto'>
              ...
              <span className='text-zinc-900 font-serif italic lowercase outline-text-subtle'>
                agora é
              </span>{' '}
              digital.
            </h1>
            ...
            <p className='text-zinc-500 text-base md:text-lg font-medium max-w-2xl mx-auto leading-relaxed'>
              O sistema operacional para barbearias de alto padrão. Gestão,
              escala e inteligência artificial em uma interface que exala
              prestígio.
            </p>
          </motion.div>
      ...
      <section className='py-24 relative'>
        <div className='max-w-7xl mx-auto px-6 md:px-16'>
          <div className='text-center mb-16 space-y-4'>
            <span className='text-amber-500 font-black text-[9px] uppercase tracking-[0.6em] italic'>
              The Inside Experience
            </span>
            <h2 className='text-3xl md:text-5xl font-black text-white uppercase tracking-tighter'>
              Performance de{' '}
              <span className='text-zinc-800 font-serif italic lowercase outline-text-subtle'>
                outro nível.
              </span>
            </h2>
          ...
          <div className='relative perspective-[2000px]'>
                ...
                <div className='w-1/5 border-r border-white/5 p-4 space-y-4 hidden md:block'>
                  ...
                  <div className='space-y-2 pt-6'>
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div
                        key={i}
                        className='w-full h-3 bg-zinc-900/50 rounded-lg'
                      />
                    ))}
                  </div>
                </div>
                ...
                <div className='flex-1 p-8 space-y-8'>
                  ...
                  <div className='grid grid-cols-3 gap-4'>
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className='h-24 bg-zinc-900/40 border border-white/5 rounded-2xl p-4 flex flex-col justify-between'
                      >
            ...
            >
              <div className='w-70 h-145 bg-zinc-950 border-8 border-zinc-900 rounded-[3.5rem] shadow-2xl overflow-hidden relative'>
            ...
            >
              <div className='flex items-center gap-3'>
                ...
                <span className='text-[9px] font-black text-zinc-950 uppercase tracking-widest'>
                  +42% Conversão
                </span>
              </div>
            </motion.div>
      ...
      {/* Grid de Benefícios */}
      <section className='py-24 bg-[#080808] border-y border-white/3'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-8'>
            {[
              ...
              >
                ...
                <span className='text-[8px] font-black text-zinc-600 uppercase tracking-widest leading-tight group-hover:text-zinc-400 transition-colors'>
                  {item.text}
                </span>
              </div>
            ))}
        ...
        <div className='max-w-6xl mx-auto px-6 md:px-16 grid lg:grid-cols-2 gap-20 items-center'>
          <div className='space-y-8'>
            <div className='inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20'>
              ...
              <span className='text-amber-500 text-[9px] font-black uppercase tracking-widest'>
                IA Concierge Signature
              </span>
            </div>
            ...
            <p className='text-zinc-500 text-lg leading-relaxed font-medium italic border-l-4 border-amber-500/30 pl-8'>
              "Enquanto você foca na lâmina, nossa IA integrada gerencia
              rituais, responde dúvidas e personaliza a experiência de cada
              cliente diretamente no portal."
            </p>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4'>
              {[
                ...
                <div
                  key={i}
                  className='flex items-center gap-3 p-4 bg-zinc-900/40 border border-white/5 rounded-2xl'
                >
                ...
                <div className='flex justify-start'>
                  <div className='bg-zinc-900/80 px-6 py-4 rounded-3xl rounded-tl-none border border-white/5 max-w-[85%]'>
                    <p className='text-zinc-400 text-xs italic leading-relaxed'>
                      "Oi! Quero marcar um Corte Mestre para amanhã à tarde."
                    </p>
                  </div>
                </div>
                <div className='flex justify-end'>
                  <div className='bg-amber-500 px-6 py-4 rounded-3xl rounded-tr-none shadow-xl max-w-[85%]'>
                    <p className='text-zinc-950 text-xs font-black leading-relaxed'>
                      "Olá! Tenho às 15:30 e 16:45 com o Marco. Qual prefere?"
                    </p>
                  </div>
                </div>
                <div className='flex justify-start'>
                  <div className='bg-zinc-900/80 px-6 py-4 rounded-3xl rounded-tl-none border border-white/5 max-w-[85%]'>
                    <p className='text-zinc-400 text-xs italic leading-relaxed'>
                      "Pode ser 15:30. Já aproveita e coloca a Barba."
                    </p>
                  </div>
                </div>
                <div className='flex justify-end'>
                  ...
                  >
                    ...
                    <p className='text-white text-xs font-black italic'>
                      "Perfeito! Combo Corte + Barba reservado para amanhã às
                      15:30."
                    </p>
                  </motion.div>
                </div>
      ...
      <section className='py-24 bg-[#080808]'>
        <div className='max-w-6xl mx-auto px-6 md:px-16'>
          <div className='text-center mb-20 space-y-4'>
            <span className='text-amber-500 font-black text-[9px] uppercase tracking-[0.5em] italic'>
              Menu de Rituais
            </span>
            ...
            {SERVICES.slice(0, 3).map((service, idx) => (
              ...
              >
                ...
                <div className='p-8 space-y-6 flex-1 flex flex-col'>
                  ...
                  <p className='text-zinc-500 text-xs leading-relaxed italic opacity-80 flex-1'>
                    "{service.description}"
                  </p>
                  <div className='pt-6 border-t border-white/5 flex items-center justify-between'>
                    ...
                    <Link
                      to='/login'
                      className='w-12 h-12 bg-zinc-900 text-white rounded-xl flex items-center justify-center hover:bg-white hover:text-zinc-950 transition-all shadow-lg group-hover:bg-amber-500 group-hover:text-zinc-950'
                    >
      ...
      <footer className='py-32 bg-[#050505] relative overflow-hidden text-center'>
        <div className='absolute inset-0 bg-amber-500/2 -z-10' />
        <div className='max-w-4xl mx-auto px-6 space-y-16 relative z-10'>
          <div className='space-y-6'>
            <h2 className='text-4xl md:text-7xl font-black text-white uppercase tracking-tighter leading-tight'>
              Sua visão, <br />
              <span className='text-amber-500 font-serif italic lowercase tracking-normal'>
                nossa tecnologia.
              </span>
            </h2>
          ...
          <div className='flex flex-col sm:flex-row items-center justify-center gap-6'>
            <Link
              to='/login'
              className='w-full sm:w-auto px-16 py-7 bg-white text-zinc-950 rounded-[2.5rem] font-black text-[12px] uppercase tracking-[0.4em] hover:bg-amber-500 transition-all shadow-[0_30px_60px_rgba(0,0,0,0.5)] active:scale-95'
            >
              COMEÇAR AGORA
            </Link>
            <Link
              to='/login'
              className='w-full sm:w-auto px-16 py-7 border border-white/10 text-white rounded-[2.5rem] font-black text-[12px] uppercase tracking-[0.4em] hover:bg-zinc-900 transition-all'
            >
              VER DEMONSTRAÇÃO
            </Link>
          </div>
